...
class EditDeviceActivity : AppCompatActivity(), AnkoLogger {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val originalDeviceName = findViewById<TextView>(R.id.originalDeviceName)
        val nexDeviceName = findViewById<TextView>(R.id.nexDeviceName)

        val edit_device_name_btn  = findViewById<Button>(R.id.edit_device_name_btn)
                    ...
                    object : ObjectCallback<CustomerDeviceModel> {
                        ...
                        override fun onError(t: Throwable?) {
                            DialogUtils.createAlertDialog(
                                this@EditDeviceActivity, getString(R.string.edit_device_title),
